    ...
    <div>
        ...
        <Link to={`/profile/${post.userId._id}`} className='w-full flex items-center justify-between gap-5'>
            <div className="flex items-center gap-7">
                {post.userId.profileUrl ? <img src={`${SERVERURL}/${post.userId.profileUrl}`} alt={post.userId.name} className="w-12 h-12 object-cover object-center border rounded-full" /> : <img src={img} alt={post.userId.name} className="w-12 border rounded-full" />}
